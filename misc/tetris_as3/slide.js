...
function showPage()
{
	...
	// タグ変換
	"".match(/.*/);
	html = html.replace(/<flash src="([^"]+)" width="([0-9]+)" height="([0-9]+)">/, "<div id='swf_box'></div>");
	canvas.innerHTML = html;

	if(RegExp.$1 != "")
	{
		var so = new SWFObject(RegExp.$1, "slide_swf", RegExp.$2, RegExp.$3, "7", "#000000");
		so.write("swf_box");
	}
